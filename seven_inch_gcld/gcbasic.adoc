...
The initial power up of the GLCD to the correct operating unfornately shows nothing on the GLCD.&#160;&#160;The integrated flash on the Blue or Black PC contains no default information for the LCD.&#160;&#160;Therefore, unfortunately, upon powering the GLCD black display is shown.
