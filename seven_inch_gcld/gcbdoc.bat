...
call java com.icl.saxon.StyleSheet ..\..\seven_inch_gcld\%1.xml %GCBxsl% ^
...
if %1 == gcbasic call ..\..\seven_inch_gcld\cleanhhc.bat
copy %GCBase%\seven_inch_gcld\gcbdoc.css .
rem copy %GCBase%\seven_inch_gcld\images\logo.png .\images
...
copy  ..\..\seven_inch_gcld\images ..\..\..\..\Help.wiki.git\trunk\images 
