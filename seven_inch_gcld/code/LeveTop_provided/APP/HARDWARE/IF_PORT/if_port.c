...
/* Parameters:  None                                                                     */
/* Returns:     None                                                                     */
/* Description: Initialize 8080 -> interface between STM32 and LT768x                    */
/*---------------------------------------------------------------------------------------*/
...
{	
	...
	//  4 Control Line (PC4:CS  PC5:RS/A0  PC6:RD  PA15:WR)
...
/*---------------------------------------------------------------------------------------*/
/* Function:    S8080_CmdWrite                                                           */
/*                                                                                       */
/* Parameters:                                                                           */
/*              Cmd: Command byte                                                        */
/* Returns:     None                                                                     */
/* Description: Write a command byte through 8080 interface                              */
/*---------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------*/
/* Function:    S8080_DataWrite                                                          */
/*                                                                                       */
/* Parameters:                                                                           */
/*              data: Data byte                                                          */
/* Returns:     None                                                                     */
/* Description: Write a data byte through 8080 interface                                 */
/*---------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------*/
/* Function:    S8080_DataRead                                                           */
/*                                                                                       */
/* Parameters:  None                                                                     */
/* Returns:                                                                              */
/*              uint16_t: Received data byte                                             */
/* Description: Read a data byte through 8080 interface                                  */
/*---------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------*/
/* Function:    S8080_StatusRead                                                         */
/*                                                                                       */
/* Parameters:  None                                                                     */
/* Returns:                                                                              */
/*              uint8_t: Status data byte                                                */
/* Description: Read status data byte through 8080 interface                             */
/*---------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------*/
/* Function:    S8080_DataWrite_Pixel                                                    */
/*                                                                                       */
/* Parameters:                                                                           */
/*              data: Data word                                                          */
/* Returns:     None                                                                     */
/* Description: Write two bytes of data through 8080 interface                           */
/*---------------------------------------------------------------------------------------*/
