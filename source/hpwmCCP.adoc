...
(((Pulse width modulation,HPWM CCP)))
...
* <<_hpwm_ccptimern,HPWM_CCPTimerN>> -- CCP/PWM support for timers 2, 4 and 6 with alternative clock sources
* <<_hpwm_10_bit,HPWM 10 Bit>> -- 10-bit PWM support with other timers
* <<_hpwmoff,HPWMOff>> -- stopping a PWM channel started with HPWM
