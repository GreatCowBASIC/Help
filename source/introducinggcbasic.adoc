...
may be helpful, see <<_using_gcbasic,Using GCBASIC>> or the https://gcbasic.sourceforge.net/starting.html[GCBASIC starting guide^].
...
* https://gcbasic.sourceforge.net/Typesetter/index.php/FAQ[FAQ^] -- answers to common questions
* https://github.com/Anobium/Great-Cow-BASIC-Demonstration-Sources[Demo Code^] -- example GCBASIC programs on GitHub
...
If there is anything else that you need help on, please visit the https://sourceforge.net/forum/?group_id=169286[GCBASIC forum^].
