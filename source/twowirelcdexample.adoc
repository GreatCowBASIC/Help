...
(((Liquid Crystal Display,twowirelcdexample)))
...
* <<_lcd_io_2,LCD_IO 2>> -- full reference for this connection mode
* <<_lcd_io_2_74xx164,LCD_IO 2_74xx164>> -- the preferred 2-wire shift register method
* <<_lcd_io_4_example,LCD_IO 4 Example>> -- the 4-bit parallel equivalent
