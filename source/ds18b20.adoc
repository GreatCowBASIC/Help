...
* <<_readdigitaltemp,ReadDigitalTemp>> -- the simplest command, returning ready-to-print integer and decimal parts
* <<_readtemp,ReadTemp>> -- returns a whole-degree value only, with a faster 8-bit result
* <<_readtemp12,ReadTemp12>> -- returns the full raw 12-bit reading for advanced users who need 0.0625-degree resolution
