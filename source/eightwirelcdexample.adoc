...
(((Liquid Crystal Display,eightwirelcdexample)))
...
* <<_lcd_io_8,LCD_IO 8>> -- full reference for this connection mode
* <<_lcd_width,LCD_WIDTH>> -- setting the display width, as used above
* <<_lcd_io_4_example,LCD_IO 4 Example>> -- the 4-bit parallel equivalent, needing fewer pins
* <<_lcdcmd,LCDCmd>> -- sending raw HD44780 commands, as used throughout this example
