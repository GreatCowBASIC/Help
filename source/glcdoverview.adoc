...
For color TFT displays, any color can be defined using a valid hexadecimal word value between 0x0000 and 0xFFFF -- see the https://www.barth-dev.de/online/rgb565-color-picker/[RGB565 color picker] for a wider range of color parameters.
...
https://www.greatcowbasic.com/sample-projects.html[Graphic LCD] for
