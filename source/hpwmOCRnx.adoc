...
(((Pulse width modulation,HPWM AVR OCRnx)))
...
* <<_hardware_pwm_code_optimisation,Hardware PWM Code Optimisation>> -- reducing program size by disabling unused channels
* <<_hpwm_ccp,HPWM CCP>> -- the Microchip PIC equivalent of this command
