...
(((Microcontroller Fundamentals,Configuration)))
...
do have similar configuration settings, but they are controlled
...
* <<__config,#config>> -- the full #config directive reference
* <<__chip,#chip>> -- selecting the target microcontroller and clock speed
