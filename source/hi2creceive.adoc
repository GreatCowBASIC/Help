...
(((I2C/TWI Hardware Module,HI2CReceive)))
...
* <<_hi2csend,HI2CSend>> -- sending the register request read back here
* <<_hi2cstart,HI2CStart>> / <<_hi2cstop,HI2CStop>> -- framing the transaction used above
* <<_hi2cmode,HI2CMode>> -- selecting master mode, as used above
* <<_on_interrupt,On Interrupt>> -- handling I2C activity from an interrupt, as used in Example 2
* <<_dir,Dir>> -- setting the I2C pin directions before use, as used above
