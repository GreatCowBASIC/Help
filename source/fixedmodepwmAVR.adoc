...
(((Pulse width modulation,HPWM Fixed Mode for AVR)))
...
* <<_pwmon_for_avr,PWMOn>> -- full reference for this command
* <<_pwmoff_for_avr,PWMOff>> -- stopping the PWM output
* <<_hpwm_ccp,HPWM CCP>> -- the dynamic-mode equivalent for Microchip PIC microcontrollers
