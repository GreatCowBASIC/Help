...
(((Serial Communications,SerPrint)))
...
* <<_initser,InitSer>> -- configures the channel before SerPrint can be used
* <<_sersend,SerSend>> -- sending the raw CR/LF bytes SerPrint omits
