...
(((7-Segment Displays,TMWrite4Dig)))
...
* <<_7_segment_displays_tm1637_4_digits,7 Segment Displays - TM1637 4 Digits>> -- category overview and a full worked example using TMWrite4Dig
