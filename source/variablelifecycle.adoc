...
(((Variables Operations,Variable Lifecycle)))
...
* <<__option_explicit,Option Explicit>>
* <<_dim,Dim>> -- declaring variables, as used throughout this page
* <<_using_variables,Using Variables>> -- accessing individual bytes of a wider variable directly, without aliasing by name
