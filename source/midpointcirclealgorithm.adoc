...
(((Example Programs,Midpoint Circle Algorithm)))
...
The algorithm is a variant of https://en.wikipedia.org/wiki/Bresenham%27s_line_algorithm[Bresenham's line algorithm], and is thus sometimes known as Bresenham's circle algorithm, although it was not actually invented by https://en.wikipedia.org/wiki/Jack_Elton_Bresenham[Jack E. Bresenham].
...
* <<_circle,Circle>> -- the command reference for drawing circles
