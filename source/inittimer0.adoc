...
* <<_inittimer0_8bit_16bit,InitTimer0 8bit/16bit>> -- for microcontrollers whose Timer 0 supports 8-bit or 16-bit operation
* <<_on_interrupt,On Interrupt>> -- attaching the Timer0Overflow handler, as used above
* <<_settimer,Settimer>> / <<_starttimer,StartTimer>> -- setting a start value and starting a timer explicitly
