...
{empty} +
{empty} +
 - The IDE Tools... commands (function keys F5 - F8) start a GCBASIC utility which calls the batch files for compiling source code and programming
...
ifdef::backend-pdf[]
image:Prefs1.png[graphic,width=640,height=480]
[.text-center]_(animated walkthrough available in the CHM/online help)_
endif::[]
{empty} +
{empty} +
...
ifdef::backend-pdf[]
image:Prefs2.png[graphic,width=640,height=480]
[.text-center]_(animated walkthrough available in the CHM/online help)_
endif::[]
{empty} +
{empty} +
...
ifdef::backend-pdf[]
image:PPtool.png[graphic,width=640,height=480]
[.text-center]_(animated walkthrough available in the CHM/online help)_
endif::[]
{empty} +
{empty} +
...
* <<_introducing_gcbasic,Introducing GCBASIC>> -- category overview
* <<_pic_users_and_beginners_start_here,PIC Users and Beginners: Start Here>> -- your first GCBASIC program once the IDE is installed
* <<_command_line_parameters,Command Line Parameters>> -- compiling and flashing from the command line instead of the IDE
