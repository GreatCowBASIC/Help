...
Comments are explanatory notes embedded within the code.
They are used to remind yourself, and to inform others, about the function of your program.
Comments are ignored by the compiler.

You can comment out sections of code by placing an apostrophe at
...
* <<_compiler_insights,Compiler Insights>> -- forcing custom comments into the generated ASM output
* <<_miscellaneous,Miscellaneous>> -- combining statements on a single line
