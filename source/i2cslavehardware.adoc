...
(((Example Programs,I2C Slave Hardware)))
...
* <<_i2c_master_hardware,I2C Master Hardware>> -- the corresponding master-side example
* <<_hi2c_overview,HI2C Overview>> -- the hardware I2C command reference
* <<_keypaddata,KeypadData>> -- reading the physical keypad
