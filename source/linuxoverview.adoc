...
[start=1]
 . Install FreeBasic from your distribution's repository or http://www.freebasic.net/wiki/CompilerInstalling
...
For Atmel AVR microcontroller programming, you will need `avrdude`. It should be available in your distribution's repository. If not, check here: http://www.nongnu.org/avrdude/
