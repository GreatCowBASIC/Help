...
(((GCBASIC Compiler Insights,Acknowledgements)))
...
Chuck Hellebuyck - His documentation for the GLCD and other pieces, see https://www.elproducts.com[www.elproducts.com].

Frank Steinberg - GCode IDE for GCBASIC.

Alexy T. - SynWrite IDE used for the GCB IDE, see https://www.uvviewsoft.com/synwrite[SynWrite website]
...
Chris Roper for the bitwise methods, including the library featuring FnEquBit, FnNotBit, FnlslBit, FnlsrBit, SetWith, and 47xxx.
...
See the https://asciidoctor.org/[asciidoctor Web site] and the https://discuss.asciidoctor.org/[support forum].

**See Also:**

* <<_libraries_overview,Libraries Overview>> -- the libraries these contributors built
* <<_tricks_and_tips,Tricks and Tips>> -- category overview
