...
* <<_ds18b20,DS18B20>> -- category overview
* <<_readtemp12,ReadTemp12>> -- returns the unrounded raw 12-bit reading instead
* <<_readdigitaltemp,ReadDigitalTemp>> -- returns ready-to-print integer and decimal parts instead of a raw value
