...
(((Serial Communications,HSerReceiveFrom)))
...
* <<_hserreceive,HSerReceive>> -- reading from the default USART port without specifying a port number
* <<_hsersend,HSerSend>> -- the sending counterpart to HSerReceiveFrom
