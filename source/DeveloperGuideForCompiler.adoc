...
Step 3.iv; Step 3.xi, 3.xiv and xvi. There are Find compiler directives; Runscripts, process IFDEFs and replace Constants values.&#160;&#160;
This means constants that are not created by the Find compiler directives step are clearly not existing in the RunScripts step, and the same applies to the process IFDEFs step.&#160;&#160;So, please consider the order of constant creation in terms of these steps.
