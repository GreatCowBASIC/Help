...
* <<_select,Select Case>> -- alternative when choosing between more than two branches
* <<_do,Do>> -- looping construct used to repeat the check in the example above
* <<_for,For>> -- fixed-count loop alternative to Do
* <<_readad,ReadAD>> -- reading the sensor value tested in the example above
