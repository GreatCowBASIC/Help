...
include::varbytes.adoc[]

include::variablesadvanced.adoc[]

include::variableassignment.adoc[]

include::AVRGPRuage.adoc[]

ifdef::backend-pdf[<<<]

== Reference Data

include::refererencedata.adoc[]
...
include::deviceconfigurationRead.adoc[]
...
include::fontsandcharacters.adoc[]
...
include::ili9488controllers.adoc[]
...
include::st7567controllers.adoc[]
...
include::lcd_io14.adoc[]

include::lcd_io14portconfiguration.adoc[]

include::lcd_io16.adoc[]
...
include::spi2mode.adoc[]

include::spi2transfer.adoc[]

include::FastHWSPI2Transfer.adoc[]
...
include::bytetohex.adoc[]

include::bytetostring.adoc[]
...
include::integertohex.adoc[]

include::integertostring.adoc[]
...
include::longtohex.adoc[]

include::longtostring.adoc[]
...
include::varsingletobin.adoc[]

include::singletohex.adoc[]

include::singletostring.adoc[]

include::stringtobyte.adoc[]

include::stringtolong.adoc[]

include::stringtosingle.adoc[]

include::stringtoword.adoc[]

include::VarsULongInttobin.adoc[]

include::wordtobin.adoc[]

include::wordtohex.adoc[]

include::wordtostring.adoc[]
...
include::undefine.adoc[]

include::ifpp.adoc[]

include::ifnotpp.adoc[]
...
// removed 10022024 include::optionfloat.adoc[]
...
include::optionshadowregister.adoc[]

include::optionremoveavrvectors.adoc[]

include::optionusermodeonly.adoc[]
...
This is the Graphical GCBASIC section of the Help file.  Please refer the sub-sections for details using the contents/folder view.
...
This is the GCBASIC for Linux section of the Help file.  Please refer the sub-sections for details using the contents/folder view.
...
This is the GCBASIC for Pi section of the Help file.  Please refer the sub-sections for details using the contents/folder view.
...
This is the GCBASIC for Apple macOS section of the Help file.  Please refer the sub-sections for details using the contents/folder view.

include::macosoverview.adoc[]

== GCBASIC for FreeBSD
This is the GCBASIC for FreeBSD OS section of the Help file.  Please refer the sub-sections for details using the contents/folder view.
