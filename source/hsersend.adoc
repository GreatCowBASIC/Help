...
(((Serial Communications,HSerSend)))
...
* <<_hserprint,HSerPrint>> -- sending a string, integer, word, or long, rather than a single raw byte
* <<_hserreceive,HSerReceive>> -- the receiving counterpart to HSerSend
* <<_dir,Dir>> -- setting the pin directions before sending, as used above
