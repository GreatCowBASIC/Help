...
* <<_if,If>> -- two-way branch alternative for simpler conditions
* <<_conditions,Conditions>> -- background on how conditions are evaluated
* <<_readad,ReadAD>> -- reading the potentiometer value tested in Example 1
* <<_cls,CLS>> -- clearing the LCD before printing a result, as used in Example 1
* <<_print,Print>> -- displaying the selected branch's text, as used in Example 1
