...
`#OPTION STARTUPMETHODSDISABLED`&#160;&#160;This will instruct the compiler to disable all library startup methods.&#160;&#160;Examination of the generated ASM will show the disabled methods as comments.&#160;&#160;The calls to these methods can be added into the user program at a suitable place ( if required ).
