...
(((7-Segment Displays,7 Segment Displays - TM1637 6 Digits)))
...
ifdef::backend-pdf[]
image::TM1637_6d.png[graphic,align="center", 40%]
...
English -  https://gcbasic.sourceforge.net/library/TM1637/TM1637_V2.4_EN.pdf[here].

Chinese - https://gcbasic.sourceforge.net/library/TM1637/TM1637_V2.4.pdf[here].
...
* <<_7_segment_displays_overview,7 Segment Displays Overview>> -- category overview
* <<_7_segment_displays_tm1637_4_digits,7 Segment Displays - TM1637 4 Digits>> -- related command in the same category
* <<_7_segment_displays_legacy,7 Segment Displays - Legacy>> -- related command in the same category
