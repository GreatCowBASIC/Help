...
----
*Key line:* `SETSMT1PERIOD ( 4045000 )` -- sets the 24-bit match value that determines SMT1's overflow period; combined with the `SMT_FOSC`/`SMTPres_1` clock settings below, 4,045,000 ticks works out to approximately 1.000 second.
{empty} +
{empty} +
