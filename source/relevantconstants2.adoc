...
(((Serial Communications,RS232 Software Overview)))
...
* <<_rs232_software_overview_optimised,RS232 Software Overview - Optimised>> -- related command in the same category
