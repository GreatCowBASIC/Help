...
* <<_dim,Dim>> -- declaring arrays
* <<_alloc,Alloc>> -- declaring memory directly
* <<_efficient_implementation_of_lookup_reference_tables_in_gcbasic,Efficient Implementation of Lookup Reference Tables in GCBASIC>> -- an alternative to large arrays
