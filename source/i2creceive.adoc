...
----
  ...
  Loop
----
*Key line:* `I2CReceive ValueIn` -- reads one byte from the I2C bus into `ValueIn`, automatically ACKing since no `_ack_` argument was given.
...
* <<_i2csend,I2CSend>> -- the counterpart command for transmitting data
* <<_i2cstart,I2CStart>> / <<_i2cstop,I2CStop>> -- framing the transaction used above
* <<_i2crestart,I2CRestart>> -- switching direction within a transaction
