...
(((Serial Communications,HSerGetNum)))
...
* <<_hserreceive,HSerReceive>> -- reading a single raw byte instead of a whole number
* <<_hsergetstring,HSerGetString>> -- reading a whole text string instead of a number
