...
(((Graphical LCD,ST7735 Controllers)))
...
* <<_glcdcls,GLCDCLS>> -- clearing the display
...
* <<_glcdrotate,GLCDRotate>> -- rotating the display, implemented for this controller by the internal GLCDRotate_ST7735 routine
