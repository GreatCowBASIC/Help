...
For more information on the QBASIC PLAY command set, see https://en.wikibooks.org/wiki/QBasic/Appendix[QBasic Appendix on Wikibooks]
...
* <<_play_rtttl,Play RTTTL>> -- playing a tune from the Nokia RTTTL string format instead
