...
needed. However, it is good practice to "dimension" all byte variables and to use `#OPTION EXPLICiT`.&#160;&#160;`#OPTION EXPLICiT` mandates the "dimensioning" of all variables in the user program.Usuing `#OPTION EXPLICiT` will improve the quality of the program.
