...
(((7-Segment Displays,7 Segment Displays - Legacy)))
...
* <<_common_cathode,Common Cathode>> -- wiring example for a Common Cathode display
* <<_common_anode,Common Anode>> -- wiring example for a Common Anode display
* <<_displaychar,DisplayChar>> -- displaying an ASCII character
* <<_displayvalue,DisplayValue>> -- displaying a numeric digit
