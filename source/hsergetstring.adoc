...
(((Serial Communications,HSerGetString)))
...
* <<_hserreceive,HSerReceive>> -- reading a single raw byte instead of a whole string
* <<_hsergetnum,HSerGetNum>> -- reading a whole number instead of a text string
