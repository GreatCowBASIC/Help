...
* <<_glcd_overview,GLCD Overview>> -- the GLCD command family this initialisation supports
* <<_glcdcls,GLCDCLS>> -- clearing the screen, the last step InitGLCD performs
* <<_glcdwritebyte,GLCDWriteByte>> -- the low-level command used internally to reach the controller
