...
This ATan function is a fast XY vector to integer degree algorithm developed in Jan 2011, see https://www.romanblack.com[RomanBlack.com] and see https://www.romanblack.com/integer_degree.htm[here]
...
* <<_trigonometry_sine_cosine_and_tangent,Trigonometry Sine, Cosine and Tangent>> -- related command in the same category
