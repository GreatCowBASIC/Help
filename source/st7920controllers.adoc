...
(((Graphical LCD,ST7920 Controllers)))
...
----
*Key line:* `#DEFINE GLCD_TYPE GLCD_TYPE_ST7920` -- tells `<glcd.h>` to compile in the ST7920 driver rather than any of the library's other supported controllers; every other `GLCD_*` constant below only takes effect once this line selects the ST7920.
...
https://www.crystalfontz.com/controllers/ST7920.pdf[here.]
