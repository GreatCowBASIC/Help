...
(((Graphical LCD,UC1601 Controllers)))
...
ifdef::backend-pdf[]
image:UC1601.png[graphic,width=396,height=66]
...
|Required. Datasheet-defined, typically 0x70 through 0x73 depending on the hardware address strap.
|===
...
|===
For a UC1601 datasheet, please refer https://gcbasic.sourceforge.net/library/DISPLAY/UC1601.pdf[here].
