...
----
   ...
   #define USART_TX_BLOCKING
    ...
    HSerPrintCRLF
----
*Key line:* `HserPrint Fill ( 16, "{asterisk}" )` -- builds a 16-character string made entirely of the pad character (`{asterisk}`) and prints it, useful for drawing a separator line on an LCD or terminal.
