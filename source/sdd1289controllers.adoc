...
(((Graphical LCD,SDD1289 Controllers)))
...
|`GLCD_WR`
|Specifies the output pin that is connected to the Write strobe on the GLCD.
|Required
...
|`GLCD_DB0` through `GLCD_DB15`
|Specifies the 16 output pins connected to the parallel data bus on the GLCD.
|All 16 bits are required
|===
...
For a SSD1289 datasheet, please refer https://gcbasic.sourceforge.net/library/DISPLAY/SDD1289.pdf[here]. +
