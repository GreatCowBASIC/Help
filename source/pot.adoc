...
* <<_dir,Dir>> -- related command in the same category
* <<_getuserid,GetUserID>> -- related command in the same category
* http://ladyada.net/library/rccalc.html[ladyada.net/library/rccalc.html] -- calculating the capacitor value (not associated with GCBASIC)
