...
(((Example Programs,Serial/RS232 Buffer Ring)))
...
* <<_hserreceive,HSerReceive>> -- receiving a byte directly, called from the interrupt handler above
* <<_hsersend,HSerSend>> -- sending a byte, used above to echo the buffered character
