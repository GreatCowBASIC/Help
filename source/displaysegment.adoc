...
(((7-Segment Displays,DisplaySegment)))


*Syntax:*
[subs="specialcharacters,quotes"]
----
    DisplaySegment (_display, data_)
----
...
* <<_displaychar,DisplayChar>> -- displaying an ASCII character via automatic segment lookup
* <<_displayvalue,DisplayValue>> -- displaying a decimal or hex digit
