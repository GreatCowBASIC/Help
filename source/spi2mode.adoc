...
|`MasterSlow`
|SPI clock baud rate is calculated INT( ChipMHz / INT( SPI2_BAUD_RATE  ) / 16 * 1000) + 1.  Where SPI2_BAUD_RATE defaults to 4000.  
...
|`Master`
|SPI clock baud rate is calculated as INT( ChipMHz / INT( SPI2_BAUD_RATE  ) / 4 * 1000) + 1.  Where SPI2_BAUD_RATE defaults to 4000.
