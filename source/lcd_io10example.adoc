...
(((Liquid Crystal Display,lcd_io10example)))
...
This for the 16F877A, but, it can easily be adapted for any other microcontrollers.
...
* <<_lcd_io_10,LCD_IO 10>> -- full reference for this connection mode, including the address constant table
* <<_lcd_io_12,LCD_IO 12>> -- the alternate Ywmjkdz I2C expander layout mentioned above
* <<_ds18b20,DS18B20>> -- reading the temperature sensor used in the second example
