...
(((Pulse width modulation,HPWMUpdate for CCP/PWM Modules(s))))
...
* <<_hpwm_ccp,HPWM CCP>> -- sets the initial frequency, timer source, and duty cycle that HPWMUpdate then adjusts
* <<_hpwmoff,HPWMOff>> -- stopping the PWM signal entirely
