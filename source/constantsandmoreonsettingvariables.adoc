...
(((Variables Operations,More on setting Variables and Constants)))
...
* <<_setting_variables,Setting Variables>> -- the assignment and calculation rules these shorthand operators build on
* <<_inittimer0,InitTimer0>> -- using the OSC/EXT/EXTOSC clock source constants shown above
