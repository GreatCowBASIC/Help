...
* <<_inittimer0,InitTimer0>> -- for microcontrollers with only an 8-bit Timer 0 module
* <<_settimer,Settimer>> -- preloading the timer, as used above
* <<_starttimer,StartTimer>> -- starting the timer, as used above
