...
shift register 74HC595, as detailed at https://gcbasic.sourceforge.net/library/DIAGRAMS/1-Wire%20LCD/[*here*].
 +
...
https://gcbasic.sourceforge.net/library/DIAGRAMS/2-Wire%20LCD/[*here*]
 +
...
* <<_lcd_io_2_74xx174,LCD_IO 2_74xx174>>
* <<_lcd_io_4,LCD_IO 4>>
* <<_lcd_io_8,LCD_IO 8>>
* <<_lcd_io_10,LCD_IO 10>>
* <<_lcd_io_12,LCD_IO 12>>
* <<_lcd_width,LCD_WIDTH>>
* <<_lcd_speed,LCD_SPEED>>
