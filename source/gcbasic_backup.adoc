...
The GCBASIC Development Team @ 2021


This document supports GCBASIC compiler.
...
ifdef::backend-pdf[<<<]
Thank you for installing GCBASIC.  Hopefully using it will be a pleasant experience for you!
If you have any problems, suggestions or compliments, please post on the GCBASIC forum - your feedback is always welcome.
...
GCBASIC can be configured to work with other programmers.  You can set this up by editing `flashpic.bat` or `flashavr.bat` command files and choosing an appropiate programmer.
