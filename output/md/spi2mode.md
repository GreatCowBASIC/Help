...
SPI clock baud rate is calculated INT( ChipMHz / INT( SPI2\_BAUD\_RATE )
/ 16 \* 1000) + 1. Where SPI2\_BAUD\_RATE defaults to 4000.
...
SPI clock baud rate is calculated as INT( ChipMHz / INT(
SPI2\_BAUD\_RATE ) / 4 \* 1000) + 1. Where SPI2\_BAUD\_RATE defaults to
4000.
...
SPI clock baud rate is calculated as INT( ChipMHz / INT(
SPI2\_BAUD\_RATE ) / 2 \* 1000) + 1. Where SPI2\_BAUD\_RATE defaults to
4000.
