...
| `/A:assembler`                         | Batch file used to call assembler<sup>(1)</sup>. If `/A:GCASM` is given, Great Cow BASIC will use its internal assembler.                                                                                                                                                                                                                            | The program will not be assembled                                 |
...
A batch file to load the `ASM` from Great Cow BASIC into `MPASM`.
...
A batch file to compile in Great Cow BASIC then load the `ASM` from
Great Cow BASIC into `GPASM`. Command line should be like this:
...
Great Cow BASIC will compile the file, then assemble the program, and
run this command:
...
chip Great Cow BASIC will pass to WinPIC.
