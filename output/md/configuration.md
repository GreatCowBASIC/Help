...
Fuses". Great Cow BASIC cannot set these - you MUST use the programmer
software.)*</span>
...
This can all be rather confusing - hence, Great Cow BASIC will
automatically set some config settings, unless told otherwise:
