...
-   <a href="readdigitaltemp" class="link" title="ReadDigitalTemp">ReadDigitalTemp</a> — the
    simplest command, returning ready-to-print integer and decimal parts
-   <a href="readtemp" class="link" title="ReadTemp">ReadTemp</a> — returns
    a whole-degree value only, with a faster 8-bit result
-   <a href="readtemp12" class="link" title="ReadTemp12">ReadTemp12</a> — returns
    the full raw 12-bit reading for advanced users who need
